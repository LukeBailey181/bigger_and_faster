...
def arch_cpu_time(model, arch, args, save_dir, quant=False, config_keys=None, partition_name=''):
            ...
            for hidden_size in hidden_sizes:
                ...
                for ffn_size in ffn_sizes:
                    ...
                    for qkv_size in qkv_sizes:
                        ...
                        arch_cpu_time(model, config, args, save_dir, quant=True, config_keys=config_keys, partition_name='')
        else:
